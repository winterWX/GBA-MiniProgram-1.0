let imagesUrl = 'https://zhj.wellness.hangseng.com/images/miniprogram';
App({
  onLaunch: function () {
    // 展示本地存储能力
  ...
  globalData: {
    ...
    runData: null,
    baseUrl:'https://zhj.wellness.hangseng.com',
    imagesUrl: 'https://zhj.wellness.hangseng.com/images/miniprogram',
    token: '',
    phoneNumber: '',
    isLogin : 0,  //未登录
    loginSuccess: false,
